...
To learn more about data modeling, see [Data Modeling](/ai-builder/data-modeling.md).
...
To learn more about UI configuration, see [UI Configuration](/ai-builder/ui-builder.md).
...
To learn more about workflows, see [Workflow Management](/ai-builder/workflow.md).
...
To learn more about building complete systems, see [Solutions](/ai-builder/dsl-reconciler.md).

## Security & Audit

Before letting an AI Agent operate NocoBase, we recommend understanding the authentication methods, permission controls, and operation auditing — ensuring the AI only does what it should, with every step recorded. See [Security & Audit](/ai-builder/security.md).
...
* [Environment Management](/ai-builder/env-bootstrap.md) — Environment checks, installation, deployment, upgrades, and troubleshooting
* [Data Modeling](/ai-builder/data-modeling.md) — Create and manage data tables, fields, and relationships
* [UI Configuration](/ai-builder/ui-builder.md) — Create and edit pages, blocks, popups, and interactive linkage
* [Workflow Management](/ai-builder/workflow.md) — Create, edit, enable, and diagnose workflows
* [ACL Configuration](/ai-builder/acl.md) — Manage roles, permission policies, user bindings, and risk assessments
* [Solutions](/ai-builder/dsl-reconciler.md) — Batch-build entire business systems from YAML
* [Plugin Management](/ai-builder/plugin-manage.md) — View, enable, and disable plugins
* [Release Management](/ai-builder/publish.md) — Cross-environment releases, backup & restore, and migration
...
* [Security & Audit](/ai-builder/security.md) — Authentication methods, permission controls, and operation auditing
