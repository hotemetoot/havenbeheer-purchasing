...
<Tabs>
  <Tab label="Manual Installation and Connection" value="manual-install">
    ...
    Configuration files and application data are stored in your home directory by default. See [NB\_CLI\_ROOT environment variable](/api/cli/index.md#environment-variables) for details.
...
<Tabs>
  <Tab label="Manual Connection" value="manual-connect">
    ...
    Configuration files are stored in your home directory by default. See [NB\_CLI\_ROOT environment variable](/api/cli/index.md#environment-variables) for details.
    ...
    2. **Select Authentication Method** — Choose an [authentication method](/ai-builder/security.md) (OAuth is recommended for quick setup)
...
If you need to manage existing NocoBase instances (such as test or production environments), or switch between multiple environments, see [Environment Management](/ai-builder/env-bootstrap.md) — covering environment checks, adding environments, upgrades, and troubleshooting.
...
* [Environment Management](/ai-builder/env-bootstrap.md) — Environment checks, adding environments, upgrades, and troubleshooting
* [NocoBase CLI Command Reference](/api/cli/index.md) — Full parameter documentation for all commands
* [Installation Methods and Version Comparison](/get-started/quickstart.md) — Different installation methods and version channels for NocoBase
