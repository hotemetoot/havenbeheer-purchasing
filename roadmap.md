...
| 013 | Regular-purchase flag — procurement-set `is_regular` bypasses director below $300; sub-$300 default flips to director; retires `needs_director_approval` routing (D37) | ⏳ chunk drafted |
