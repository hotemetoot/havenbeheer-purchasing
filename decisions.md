...
**Status:** live-verified 2026-07-14 (each change read back directly via `nb api`). Rollback: re-add `sent`/`confirmed` enum options + `sent_at`/`confirmed_at` date fields; re-enable guard `369970105614336`.
